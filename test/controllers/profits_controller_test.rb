...
class ProfitsControllerTest < ActionController::TestCase
  ...
  test "should create profit" do
    assert_difference('Profit.count') do
      post :create, profit: { budget: @profit.budget, group_id: @profit.group_id, name: @profit.name, user_id: @profit.user_id }
    end
  ...
  test "should update profit" do
    patch :update, id: @profit, profit: { budget: @profit.budget, group_id: @profit.group_id, name: @profit.name, user_id: @profit.user_id }
    assert_redirected_to profit_path(assigns(:profit))
  end
